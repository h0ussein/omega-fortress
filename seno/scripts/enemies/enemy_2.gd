...
func _ready():
	...
	# Set max_health for enemy2 specifically
	max_health = 150.0  # Set the max health for enemy_2 (slightly lower than enemy1)
	...
	print("Enemy2: Ready with health: " + str(health) + "/" + str(max_health))
...
func create_health_bar():
	...
	print("Enemy2: Created health bar")
