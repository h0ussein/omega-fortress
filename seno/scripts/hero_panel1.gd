...
#Add process_mode to make sure the hero panel works during pause
func _ready():
...
func show_panel():
	...
	print("HeroPanel: Panel shown")

# Add compatibility with the new UI system
func show_panel_for_hero(hero):
	...
	print("HeroPanel: Showing panel for hero")
